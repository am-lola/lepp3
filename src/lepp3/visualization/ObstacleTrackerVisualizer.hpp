...
public:
  ObstacleTrackerVisualizer(GMM::DebugGUIParams const& parameters,
...
void ObstacleTrackerVisualizer::initUI() {
  ...
  const char* colorModes[GMM::ColorMode::NR_ITEMS] = { "No Color", "Soft Assignment", "Hard Assignment" };
  _comboBoxColorMode = _windowMain->AddComboBox("Color Mode", colorModes, GMM::ColorMode::NR_ITEMS, GMM::ColorMode::SOFT_ASSIGNMENT);
